"""
Risk Engine
- Torino/Palermo ve yaklaşım mesafesi/çap eşiği ile risk seviyesini hesaplar
"""
...
async def compute_risk_levels() -> Dict[str, int]:
    """Tüm risk kayıtları için risk_level hesapla ve güncelle (toplu sorgu)."""
    ...
    # Hızlı lookup için haritalar oluştur
