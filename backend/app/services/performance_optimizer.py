...
AI görsel üretim sistemi için performans optimizasyon hizmetleri
"""
...
class PerformanceOptimizer:
    ...
    def get_current_metrics(self) -> PerformanceMetrics:
        ...
        try:
            ...
            # RPS calculation (last 60 seconds)
    ...
    async def optimize_system_resources(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # CPU optimization (adjust concurrency)
            cpu_percent = psutil.cpu_percent(interval=0.5)
            if cpu_percent > self.config.cpu_throttle_threshold:
                # Temporarily reduce concurrent generations
...
# Context manager for generation slots
