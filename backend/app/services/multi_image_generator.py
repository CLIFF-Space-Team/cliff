...
class MultiImageRequest(BaseModel):
    ...
    content_type: Optional[ContentType] = Field(default=None, description="İçerik türü")
    ...
    image_count: int = Field(default=4, ge=1, le=8, description="Üretilecek görsel sayısı")
...
3. Anahtar kavramları çıkar
4. Görsel öğeleri tanımla
...
Yanıtını şu JSON formatında ver:
{
  ...
  "visual_elements": ["görsel öğe1", "görsel öğe2"],
