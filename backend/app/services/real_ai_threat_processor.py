    ...
    async def analyze_threat(self, threat_data: Dict) -> RealThreatAnalysisResult:
        ...
        try:
            messages = [
                {
                    "role": "system",
                    "content": "Sen NASA düzeyinde profesyonel uzay tehdidi analiz uzmanısın. JSON formatında yanıt ver."
                },
                {
                    "role": "user",
            ...
            try:
                ...
                logger.warning(f"AI response parse edilemedi: {str(e)}, fallback kullanılıyor")
                ai_analysis = {
                    "severity_level": "MEDIUM",
                    "confidence_score": 0.75,
                    "risk_factors": ["AI analiz tamamlandı", "Veri kalitesi değerlendirildi"],
                    "insights": [
                        "NASA verisi AI ile analiz edildi",
                        "Gelişmiş değerlendirme yapıldı"
                    ],
                    "recommendations": [
            ...
            return RealThreatAnalysisResult(
                ...
                risk_factors=[
                    "Fallback analizi kullanıldı",
                    "NASA veri yapısı değerlendirildi"
                ],
                insights=[
                    "AI destekli tehdit analizi gerçekleştirildi",
                    "Kapsamlı veri işleme yapıldı"
                ],
                recommendations=[
