/**
 * Advanced Shader Library for Impact Simulator
 * Reusable GLSL shader chunks for photorealistic rendering
 */
...
export const NoiseShaders = {
  ...
  /**
   * 2D Voronoi/Worley noise for crater patterns
   */
  worley2D: `
    vec2 hash2(vec2 p) {
...
export const CraterShaders = {
  ...
  terrainBlending: `
    vec3 blendTerrainLayers(
      ...
      // Layer transitions based on crater depth
...
export const DebrisShaders = {
  /**
   * Temperature-based material properties
   */
  temperatureMaterial: `
...
/**
 * Combined shader utilities
 */
export const ShaderUtils = {
  /**
   * Get complete shader with all utilities
   */
