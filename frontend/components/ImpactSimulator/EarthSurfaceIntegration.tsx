 ...
 * Elastik dalga denklemi ve malzeme fiziği
 */
export function EarthSurfaceIntegration({
    ...
    return new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          // Krater formasyonu - parabolik profil
          ...
          // Ejecta blanket - kraterin dışında materyaller
          ...
          // Seismic ripples - elastik dalgalar
          ...
          // Normal boyunca deplasmanı uygula
      ...
      fragmentShader: `
        ...
        void main() {
          // Yüzey renklendirme - krater içi koyulaşma
  ...
  useFrame((state, delta) => {
    ...
    // Krater derinliği (km) - D/R ≈ 0.2 (empirik oran)
    const depth_km = craterRadius_km * 0.2
    
    // Rim yüksekliği - genelde derinliğin %4'ü
    const rim_km = craterRadius_km * 0.04
    
    // Scene scale'e dönüştür
