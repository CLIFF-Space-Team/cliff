...
/**
 * Seamless crater-Earth integration
 * Blends crater geometry with Earth surface using advanced shader techniques
 */
export function CraterEarthOverlay({
  ...
  // Create decal geometry for crater overlay
  ...
  const blendMaterial = useMemo(() => {
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        // Simple noise for texture blending
        float hash(vec2 p) {
        ...
        void main() {
          ...
          if (vDistFromCenter < 1.0) {
            ...
            // Blend crater with Earth at edges
